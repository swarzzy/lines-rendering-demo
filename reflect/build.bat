...
cl /MP /W3 /Fo%ObjOutDir% %CommonDefines% /I%ClReflectIncludeDirectory% %CommonCompilerFlags% src/impl/Main.cpp /link %CommonLinkerFlags%

cl /MP /W3 /Fo%ObjOutDir% %CommonCompilerFlags% src/impl/Metaprogram.cpp /link /INCREMENTAL:NO /OPT:REF /MACHINE:X64 /DLL /EXPORT:Metaprogram /OUT:%BinOutDir%\Metaprogram.dll /PDB:%BinOutDir%\Metaprogram.pdb
