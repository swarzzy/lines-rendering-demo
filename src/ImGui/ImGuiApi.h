...
#define IMGUI_CHECKVERSION(api) (api)->igDebugCheckVersionAndDataLayout(IMGUI_VERSION, sizeof(ImGuiIO), sizeof(ImGuiStyle), sizeof(ImVec2), sizeof(ImVec4), sizeof(ImDrawVert), sizeof(ImDrawIdx))
...
typedef struct
{
    ...
    ImGuiStackTool*(*ImGuiStackTool_ImGuiStackTool)(void);
    ...
    bool(*ImGui_ImplSDL2_ProcessEvent)(const union SDL_Event* event);
    void(*ImGui_ImplSDL2_NewFrame)(void);
    bool(*ImGui_ImplSDL2_InitForOpenGL)(struct SDL_Window* window,void* sdl_gl_context);
    bool(*ImGui_ImplDX11_Init)(struct ID3D11Device* device, struct ID3D11DeviceContext* device_context);
    void(*ImGui_ImplDX11_NewFrame)(void);
    void(*ImGui_ImplDX11_RenderDrawData)(struct ImDrawData* draw_data);
    bool(*ImGui_ImplSDL2_InitForD3D)(struct SDL_Window* window);
} ImGuiApi;

#define IMGUI_GET_API_PROC_NAME "GetImGuiAPI"
typedef ImGuiApi*(GetImGuiAPIProc)();
